<div class="post-summary">
	...
	<p class="post-image">
		<a href="$Link" title="<%t SilverStripe\\Blog\\Model\\Blog.ReadMoreAbout "Read more about '{title}'..." title=$Title %>">
			<% if $FeaturedImage %>
				<img class="img-fluid" src="$FeaturedImage.Fill(1080,400).URL" alt="$FeaturedImage.Title">
			<% else %>
				<img class="img-fluid" src="$Parent.FeaturedImage.Fill(950,400).URL" alt="$Parent.FeaturedImage.Title">
			<% end_if %>
		</a>
	</p>
